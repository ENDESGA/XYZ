...
## <span style="color: #777;">MATH::</span>MOTOR
...
-------
## <span style="color: #777;">VEC3::</span>TRANSFORM
...
vec3 transform( vec3 v, motor m )
{
    ...
    (
        ...
        motor( rotor( -m.r.xyz, m.r.w ), vec4( m.t.xyz, -m.t.w ) )
    ).t.xyz; // return the vec3 part of the motor translation
}
```

-------
## <span style="color: #777;">MOTOR::</span>SCLERP
